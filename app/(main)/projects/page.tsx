                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {projects.sort((a, b) => new Date(b.start_date).getTime() - new Date(a.start_date).getTime()).map((project) => (
                                <Link
                                    ...
                                    className="group block p-6 bg-gray-900 border border-gray-700 hover:border-gray-600 hover:bg-gray-800 transition-all duration-200 rounded-lg"
                                >
                                        ...
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="flex items-center gap-3">
                                                {project.project_icon && (
                                                    <Image
                                                        src={urlFor(project.project_icon).width(48 * 2).height(48 * 2).url()}
